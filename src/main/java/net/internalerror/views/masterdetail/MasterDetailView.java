package net.internalerror.views.masterdetail;
...
import net.internalerror.data.entity.SamplePerson;
import net.internalerror.data.service.SamplePersonService;
