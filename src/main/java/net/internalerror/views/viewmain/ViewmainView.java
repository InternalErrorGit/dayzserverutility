package net.internalerror.views.viewmain;
...
@PageTitle("View/main")
@Route(value = "view/main", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
public class ViewmainView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public ViewmainView() {
        addClassName("viewmain-view");
        setSizeFull();
        grid.setHeight("100%");
